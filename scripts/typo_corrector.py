...
class PhonologyReference:
    ...
    def __init__(self, valid_chars: set[str], confusion_pairs: dict[str, str]) -> None:
    ...
    def from_markdown(cls, path: str) -> "PhonologyReference":
        ...
        return cls(valid_chars=valid_chars, confusion_pairs=confusion_pairs)
    ...
    def correct(
        ...
        for entry in entries:
            if entry.confidence >= 1.0:
                continue  # digital text, untouched — nothing to correct
