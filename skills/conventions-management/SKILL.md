---
name: conventions-management
description: Guides the conventions agent through analyzing a dictionary's structure and updating persistent configuration — detecting entry layout, headword shapes, gloss format, cross-references, and morphology rules, then writing them to the phonology reference and conventions file for the Nusantara corpus extraction pipeline.
---
