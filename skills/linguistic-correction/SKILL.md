---
name: linguistic-correction
description: Guides the correction agent through validating translation accuracy, checking example sentences, resolving homonyms and variant spellings, handling multi-sense entries, and applying morphology fixes in the Nusantara corpus extraction pipeline — including the web-verification protocol for ambiguous or conflicting records.
---
